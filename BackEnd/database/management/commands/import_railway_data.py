...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.stdout.write("🚀 Starting data import to Railway...")
        ...
        for student_data in students_data:
            ...
            if created:
                ...
                user.save()
                self.stdout.write(f"✅ Created student user: {student_data['username']}")
        ...
        for teacher_data in teachers_data:
            ...
            if created:
                ...
                user.save()
                self.stdout.write(f"✅ Created teacher user: {teacher_data['username']}")
        ...
        for subject_data in subjects:
            ...
            if created:
                self.stdout.write(f"✅ Created subject: {subject_data['subject_name']}")
        
        # 5. Create Student-Subject relationships
        self.stdout.write("🔗 Creating student-subject relationships...")
        ...
        for data in student_subject_data:
            try:
                ...
                if created:
                    self.stdout.write(f"✅ Assigned {subject.subject_name} to {student.name}")
            except (Student.DoesNotExist, Subject.DoesNotExist) as e:
                self.stdout.write(f"❌ Error: {e}")
        
        # 6. Create Teacher-Subject relationships
        self.stdout.write("👨‍🏫 Creating teacher-subject relationships...")
        ...
        for data in teacher_subject_data:
            try:
                ...
                if created:
                    self.stdout.write(f"✅ Assigned {subject.subject_name} to {teacher.name}")
        ...
        try:
            ...
            for data in attendance_data:
                ...
                if created:
                    self.stdout.write(f"✅ Created attendance record for {data['student'].name} - {data['subject'].subject_name}")
        except Exception as e:
            self.stdout.write(f"❌ Error creating attendance records: {e}")
        ...
        self.stdout.write(f"   - Student-Subject relationships: {StudentSubject.objects.count()}")
        self.stdout.write(f"   - Teacher-Subject relationships: {TeacherSubject.objects.count()}")
        self.stdout.write(f"   - Attendance records: {Attendance.objects.count()}")
        
        self.stdout.write(
            self.style.SUCCESS('Successfully imported sample data to Railway!')
        ) 